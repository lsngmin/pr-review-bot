package com.pawranoid.domain.port
 ...
 *
 * 도메인 서비스([com.pawranoid.domain.service.ReviewService])는 이 인터페이스에만 의존하며,
 ...
 *
 * 구현체 예시:
 * - [com.pawranoid.infrastructure.llm.GptClient] (OpenAI)
 */
interface LlmPort {
    /**
     ...
     *
     * @param diff 라인 번호 주석이 붙은 diff (필요 시 파일 전체 내용 포함). [com.pawranoid.domain.service.ReviewService]가 조립.
